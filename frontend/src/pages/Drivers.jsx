        ...
        {tab === 'list' ? (
          <div className="tbl-wrap">
            <table>
              ...
              <tbody>
                {filtered.map(d => {
                  const isExpired = d.licence_expiry_date && d.licence_expiry_date < today;
                  return (
                    <tr key={d.id}>
                      ...
                      <td>
                        <span className={isExpired ? 'badge b-red' : 'badge b-green'} style={{ fontSize: 11 }}>
                      ...
                      <td>
                        <div className="flex gap4">
                          <button className="btn btn-ghost btn-xs" onClick={() => startEdit(d)}>✏️ Edit</button>
                          <button className="btn btn-danger btn-xs" onClick={() => deleteDriver(d.id)}>🗑️</button>
                        </div>
                      </td>
                    </tr>
                  );
